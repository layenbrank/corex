...
| 参考 | [指令 YAML](docs/reference/指令YAML.md) · [内置 Action](docs/reference/内置Action.md) · [退出码与错误码](docs/reference/退出码与错误码.md) · [数据目录与状态文件](docs/reference/数据目录与状态文件.md) · [架构](docs/reference/架构.md) · [自更新](docs/reference/自更新.md)                                      |
| 接入 | [接入总览](docs/integration/接入总览.md) · [IPC](docs/integration/IPC接入指南.md) · [Tauri](docs/integration/Tauri接入指南.md) · [编辑器集成](docs/integration/编辑器集成.md) · [MCP](docs/integration/MCP接入指南.md)                                                                                             |
| 示例 | [directives](examples/directives/README.md) · [actions](examples/actions/README.md)                                                                                                                                                                                                                                |
| 运维 | [企业部署](docs/ops/企业部署.md) · [发布与 Changelog](docs/ops/发布与Changelog.md) · [合规](docs/ops/合规说明.md) · [故障排查](docs/ops/故障排查.md)                                                                                                                                                               |
| 变更 | [v12](docs/changelog/破坏性变更-v12.md) · [v11](docs/changelog/破坏性变更-v11.md) · [v10](docs/changelog/破坏性变更-v10.md) · [v9](docs/changelog/破坏性变更-v9.md) · [v8](docs/changelog/破坏性变更-v8.md) · [v7](docs/changelog/破坏性变更-v7.md) · [v6](docs/changelog/破坏性变更-v6.md) · [v5](docs/changelog/破坏性变更-v5.md) · [v4](docs/changelog/破坏性变更-v4.md) · [archive](docs/archive/) |
...
| JS/TS 客户端 | Electron、Node | [corex-client](packages/corex-client/README.md)   |
| WASM 插件    | 第三方扩展     | [WASM 插件开发](docs/integration/WASM插件开发.md) |
